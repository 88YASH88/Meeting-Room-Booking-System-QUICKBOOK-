<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="MRBS.user.Home" %>
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <a href="room.aspx" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Book A Room</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="room.aspx">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row g-0">
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5">
                ...
                <a href="room.aspx" class="btn btn-primary py-md-3 px-md-5 me-3">Our Rooms</a>
                <a href="room.aspx" class="btn btn-light py-md-3 px-md-5">Book A Room</a>
            </div>
        </div>
        <div class="col-md-6">
