<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="queryResponse.aspx.cs" Inherits="MRBS.admin.queryResponse" %>
        ...
        <div class="flex">
            ...
            <div class="sidebar">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="Admin_Sign_out.aspx" class="flex items-center space-x-3">
                          ...
                          <asp:Repeater ID="QueryRepeater" runat="server">
                              <ItemTemplate>
                                  <tr class="hover:bg-gray-50 transition-colors">
                                      ...
                                      <td class="p-4">    <span class="px-3 py-1 rounded-full text-sm 
                                                          <%# Eval("ResponseStatus").ToString() == "Pending" ? "bg-yellow-100 text-yellow-800" :
                                                              Eval("ResponseStatus").ToString() == "Completed" ? "bg-green-100 text-green-800" :
                                                              Eval("ResponseStatus").ToString() == "Rejected" ? "bg-red-100 text-red-800" :
                                      ...
                                      <asp:Button ID="Button1" runat="server" Text="Respond"  
