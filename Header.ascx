<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="MRBS.Header" %>
             ...
             <div class="row gx-0 bg-white d-none d-lg-flex">
                 <div class="col-lg-7 px-5 text-start">
                     <div class="h-100 d-inline-flex align-items-center py-2 me-4">
                         ...
                         <p class="mb-0">QuickBook@gmail.com</p>
                     </div>
             ...
             <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                 ...
                 <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                     ...
                     <div class="nav-item dropdown">
                         ...
                         <div class="dropdown-menu rounded-0 m-0">
                             <a href="user/User_Sign_In.aspx" class="dropdown-item">User</a>
                             <a href="admin/Admin_Sign_in.aspx" class="dropdown-item">Admin</a>
                         </div>
                     </div>
                 </div>
             </nav>                    
